...
ALL_VARS="APACHE_ROOT APACHE_SERVER_NAME MY_DOMAIN URL_PATH LOGFILE VERBOSE_LEVEL VIP_CREDENTIALS FORS_RIGHTS COPA_RS_URL COPA_RS_PASSWD HTTP_PROXY HTTP_PROXY_INSECURE_MODE_FOR_TEST_ONLY"
