...
# If this variable is set to true (0) then we are running locally, that is, in developer mode. No pulling of images
# Assume Jenkins by default
IS_LOCAL=false
# Assume we scrap containers by default
